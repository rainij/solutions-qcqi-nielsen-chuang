...
- [X] Already with just 60 exercises the mathjax on the website takes alot of time. Find a solution
  to this problem.
...
- [ ] speedup code :: put the unit tests into dedicated files - use ~pytest~
- [ ] speedup code :: be more selective when tangling. E.g. drawing circuits needs not be tangled.
