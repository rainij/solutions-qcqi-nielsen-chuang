...
*** Proof
Any minimal polynomial representing $F$ is of the form
...
- Lemma :: Let $P$ and $Q$ be two minimial polynomials representing $F$ with corresponding
  coefficients $(c_e)$ and $(d_e)$. Let $n\in\{0,\ldots,N-1\}$. Assume that $c_e=d_e$ for
  all $e$ with $\mathrm{bc}(e)\leq\,n$. Then $c_e=d_e$ for all $e$ with
  $\mathrm{bc}(e)\leq\,n+1$.
...
Also note that $P(0,\ldots,0)=c_{(0,\ldots,0)}$. Hence two minimal polynomials
