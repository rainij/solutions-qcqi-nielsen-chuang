...
#+RESULTS[9f574f062ec92ef9fe648f659ca24ca5f43f7b2c]: exercise-3.17-2
...
$$
  (x_0, x_1, 1, 0, a_0, a_1) \; \mapsto \, (x_0, x_1, 1, 0, a_0\oplus c, a_1\oplus x_0\oplus x_1) ,
$$

where $c=x_0x_1$ is the carry-bit. This operation is implemented by the following circuit
(ancillas initialized to $1$ and $0$ in that order). Note that no garbage is left behind
(we uncompute it).

#+RESULTS[1209b93ccdc7022f9b2c46a456b5251004400f7a]: exercise-3.31-circuit
#+begin_example
                         ░
  x_0: ──────────────────░───■─────────■─────────■───────
                         ░   │         │         │
...
produce $x_0\oplus x_1$ within the working area. This is then added to $a_1$ by the fourth
...
#+begin_src python :results replace :exports results :tangle no :cache yes
  qc = QuantumCircuit(QuReg(2, "x"), QuReg(2, "anc"), QuReg(2, "a"))
...
#+RESULTS[a9babb7e8474a814805e84b10f94d73b85f72142]: exercise-3.32-Fred-by-Toff
:
:   c: ──■────■────■──
:        │  ┌─┴─┐  │
: x_0: ──■──┤ X ├──■──
...
#+RESULTS[db480239c56d3d3f23c76b9f23e42a54ef872f47]: exercise-3.32-Toff-by-Fred
#+begin_example
                         ░
  c_0: ──────────────────░─────■────
                         ░     │
