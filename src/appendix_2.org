...
Clearly two representations are equivalent iff there exists a G-isomorphism between
them. [[#schurs-lemma][Schur's Lemma]] will tell us that up to a scalar factor there is at most one non-zero
