...
#+begin_src python
  def make_UaN(a: int, modulus: int, num_ctrls: int = 0) -> QuantumCircuit:
  ...
  class UaNGate(Gate):
      ...
      def _define(self):
          qc = make_UaN(self._increment, self._modulus)
          self.definition = qc
...
#+RESULTS[934928c8e2e8d0b56c46d1030b3960018baad490]:
#+begin_example
     ┌───────────────────┐            ┌─────────────────────┐
q_0: ┤0                  ├─X──────────┤0                    ├
     │                   │ │          │                     │
...
q_4: ┤4                  ├─┼──┼──┼──┼─┤4                    ├
     │                   │ │  │  │  │ │                     │
a_0: ┤5  (b + 3x mod 11) ├─X──┼──┼──┼─┤5  (b + 4x mod 11)^† ├
     │                   │    │  │  │ │                     │
a_1: ┤6                  ├────X──┼──┼─┤6                    ├
     │                   │       │  │ │                     │
a_2: ┤7                  ├───────X──┼─┤7                    ├
