...
#+RESULTS[f1f5db486d992e0b41dd5488ff006ba7417d9daa]:
...
#+begin_src python :results output replace :cache yes
  print(Fraction(1/3).limit_denominator(2**53))
  print(Fraction(1/3).limit_denominator(2**54))
#+end_src

#+RESULTS[d19069a70d318c08a155e0da0cc041fb7d1a8c27]:
: 1/3
: 6004799503160661/18014398509481984
...
#+RESULTS[12dac3f369c320e8003245167dd011372c4862cb]:
: PASSED
