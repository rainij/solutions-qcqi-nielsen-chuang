...
\Qcircuit @C=1em @R=.7em {
  ...
  \lstick{\ket{b}} & \ghost{\mathrm{ADD}}        & \gate{\mathrm{INC}_N^\dagger} & \ctrl{1} & \gate{\mathrm{INC}_N} & \ghost{\mathrm{ADD}^\dagger}        & \gate{X} & \ctrl{1} & \gate{X} & \ghost{\mathrm{ADD}}        & \qw & \rstick{\ket{a+b}} \\
