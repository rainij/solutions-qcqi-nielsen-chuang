...
q_0: ┤0         ├┤0           ├┤0       ├─────┤0     ├┤1           ├┤0           ├┤0       ├─────┤0     ├»
     │          ││            ││        │     │      ││            ││            ││        │     │      │»
q_1: ┤1         ├┤1           ├┤1       ├─────┤1     ├┤2           ├┤1           ├┤1       ├─────┤1     ├»
     │  ϕinc(3) ││  ϕinc(7)^† ││  QFT^† │     │  QFT ││            ││  ϕinc(3)^† ││  QFT^† │     │  QFT │»
q_2: ┤2         ├┤2           ├┤2       ├─────┤2     ├┤3 c_ϕinc(7) ├┤2           ├┤2       ├─────┤2     ├»
     │          ││            ││        │     │      ││            ││            ││        │     │      │»
q_3: ┤3         ├┤3           ├┤3       ├──■──┤3     ├┤4           ├┤3           ├┤3       ├──o──┤3     ├»
     └──────────┘└────────────┘└────────┘┌─┴─┐└──────┘│            │└────────────┘└────────┘┌─┴─┐└──────┘»
q_4: ────────────────────────────────────┤ X ├────────┤0           ├────────────────────────┤ X ├────────»
                                         └───┘        └────────────┘                        └───┘        »
«     ┌──────────┐
...
t_7: ┤ H ├┤               ├┤               ├┤               ├┤               ├┤               ├┤               ├»
     ├───┤│               ││               ││               ││               ││               ││               │»
u_0: ┤ X ├┤1 c_(3x mod 7) ├┤1              ├┤1              ├┤1              ├┤1              ├┤1              ├»
     └───┘│               ││  c_(2x mod 7) ││               ││               ││               ││               │»
u_1: ─────┤2              ├┤2              ├┤2 c_(4x mod 7) ├┤2              ├┤2              ├┤2              ├»
          │               ││               ││               ││  c_(2x mod 7) ││               ││               │»
u_2: ─────┤3              ├┤3              ├┤3              ├┤3              ├┤3 c_(4x mod 7) ├┤3              ├»
          │               ││               ││               ││               ││               ││  c_(2x mod 7) │»
u_3: ─────┤4              ├┤4              ├┤4              ├┤4              ├┤4              ├┤4              ├»
          │               ││               ││               ││               ││               ││               │»
a_0: ─────┤5              ├┤5              ├┤5              ├┤5              ├┤5              ├┤5              ├»
