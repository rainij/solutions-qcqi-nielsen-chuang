...
#+begin_src sage
  from utils_sage import Id, X, Y, Z, delta, eps, inner, kron, P0, P1
#+end_src
...
** TODO Exercise 8.27 (Phase damping = phase ﬂip channel)
...
** TODO Exercise 8.28 (One =CNOT= phase damping model circuit)
...
** TODO Exercise 8.30 ($T_2\leq2T_1$)
